...
import com.example.jason_jukes.laihuo.activity.home.FinishWorkActivity;
...
public class AddQualificationActivity extends BaseActivity {
                ...
                if (i == 0) {
                    ...
                    if (imgs.size() == 6) {
                        ...
                        PictureSelector.create(AddQualificationActivity.this)
                                ...
                                .maxSelectNum(6 - imgs.size())// 最大图片选择数量 int
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_sure:
                ...
                if (TextUtils.isEmpty(getText(etQua))){
                    showToast("资历描述不能为空");
                    return;
                }
    ...
    private void postImg(final String path, final int size, final int len) {
        ...
        RequestParams params = new RequestParams(Contants.URL_BASE + "fileUploadCustomCertPhoto");
